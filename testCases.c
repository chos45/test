...
void TestQ4_6(CuTest *tc) {

        int targetArray[6] = {4, -9, 7, 73, 5, 19};
		int inputSize = 6;
        int expectedArray[6] = {-9, 4, 5, 7, 19, 73};
        int expectedPass = 3;
        int actualPass = Q4_Bubble(targetArray, inputSize);        
        CuAssertIntEquals(tc, expectedPass, actualPass);
...
void TestQ4_10(CuTest *tc) {
        ...
        int targetArray[10] = {43, -9, 32, 0, 87, 12, 53, 9, 5, 31};
		int inputSize = 10;
        int expectedArray[10] = {-9, 0, 5, 9, 12, 31, 32, 43, 53, 87};
        int expectedPass = 7;
        int actualPass = Q4_Bubble(targetArray, inputSize);        
        CuAssertIntEquals(tc, expectedPass, actualPass);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ3_900);
        SUITE_ADD_TEST(suite, TestQ3_1234);
